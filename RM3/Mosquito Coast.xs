...
void Area(float Asize=0.0, float spotX=0.0, float spotZ=0.0, string Paint=""){
	...
	rmSetAreaCliffType(landnoise, "Amazon"); 
...
int buildTradeArea (string TradeIslandName = "", float xLoc = 0.0, float zLoc = 0.0, float xFrac1 = 0.0, float zFrac1 = 0.0, float xFrac2 = 0.0, float zFrac2 = 0.0, string socketDef="") { 
	...
	rmAddAreaRemoveType(tradeIslandID, "UnderbrushJungle");
...
rmSetStatusText("", 0.0);
	...
	if (rmGetIsFFA()) {	
		...
		if (IsYP()) {
			if (diceThrow<0.9) {			// Coastal variation
				rmSetSeaLevel(-5.0);
				rmSetMapType("ceylon");
...
int avoidNativesMed=rmCreateClassDistanceConstraint("stuff avoids natives medium", rmClassID("natives"), 10.0);
...
if (rmGetIsFFA()==false) {	
  ...
  if (diceThrow>=0.9){			// Trade route variation
...
//	rmAddObjectDefConstraint(startID, avoidImpassableLand);
	...
	rmAddObjectDefItem(treeID, "TreeYucatan", rmRandInt(8,12), 10.0); 
...
//	rmAddObjectDefConstraint(treeID, avoidWater);
	...
	rmAddObjectDefItem(foodID, "capybara", 6, 8.0); 
...
if (diceThrow<0.9){	
	...
	if (IsYP()) {
		...
		nativeType = "native jesuit mission borneo 0";
	}
	else {  
		rmAllocateSubCivs(2); 
		rmSetSubCiv(0, "Caribs");
		rmSetSubCiv(1, "Maya");
		nativeType = "native maya village ";
	}
	
	int tupiVillageID = rmCreateGrouping("edge carib village", "native carib village "+rmRandInt(1,4));
...
// Trees
	...
	for (j=0; < (8*cNumberNonGaiaPlayers)) {   
		...
		rmAddObjectDefItem(StartAreaTree2ID, "TreeYucatan", rmRandInt(8,12), 16.0);
		rmAddObjectDefItem(StartAreaTree2ID, "TreeAmazon", rmRandInt(3,6), 12.0);
		...
		rmAddObjectDefConstraint(StartAreaTree2ID, avoidNatives);
	  	rmAddObjectDefConstraint(StartAreaTree2ID, avoidEdgeMore);
...
// Coastal variation
	...
	rmAddObjectDefItem(rhea1ID, "elk", rmRandInt(8,10), 10.0);
	...
	rmAddObjectDefItem(tapir1ID, "Moose", rmRandInt(7,9), 12.0);
	...
	rmAddObjectDefItem(moose1ID, "capybara", rmRandInt(9,12), 8.0);
	...
	rmAddObjectDefItem(rhea2ID, "elk", rmRandInt(8,10), 10.0);
	...
	rmAddObjectDefItem(tapir2ID, "Moose", rmRandInt(7,9), 12.0);
	...
	rmAddObjectDefItem(moose2ID, "capybara", rmRandInt(9,12), 8.0);
...
// Trade route variation
	...
	rmAddObjectDefItem(rhea3bID, "elk", rmRandInt(8,10), 10.0);
	...
	rmAddObjectDefItem(tapir3bID, "Moose", rmRandInt(7,9), 12.0);
	...
	rmAddObjectDefItem(rhea3ID, "elk", rmRandInt(8,10), 10.0);
	...
	rmAddObjectDefItem(tapir3ID, "Moose", rmRandInt(7,9), 12.0);
	...
	rmAddObjectDefItem(moose3ID, "capybara", rmRandInt(9,12), 8.0);
	...
	rmAddObjectDefItem(rhea4ID, "elk", rmRandInt(8,10), 10.0);
	...
	rmAddObjectDefItem(tapir4ID, "Moose", rmRandInt(7,9), 12.0);
	...
	rmAddObjectDefItem(moose4ID, "capybara", rmRandInt(9,12), 8.0);
...
// FFA
	...
	rmAddObjectDefItem(rheaxID, "elk", rmRandInt(8,10), 10.0);
	...
	rmAddObjectDefItem(tapirxID, "Moose", rmRandInt(7,9), 12.0);
	...
	rmAddObjectDefItem(moosexID, "capybara", rmRandInt(9,12), 8.0);
...
// Land underbrush stuff -- shrubs, twigs, rocks
	...
	rmAddObjectDefItem(props, "UnderbrushJungle", 1, 0.0);
	...
	rmPlaceObjectDefAtLoc(props, 0, 0.5, 0.5, 70*cNumberNonGaiaPlayers);
	...
	for(i=0; < ruinCount) {
		int stoneWallID = rmCreateGrouping("stone wall "+i, "ne_rockwall "+rmRandInt(1,4));
...
rmPlaceMapClusters("", "UnderbrushJungle"); 
