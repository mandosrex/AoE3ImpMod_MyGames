...
//	rmAddGroupingConstraint(nativeID3, avoidNatives);
	...
	rmAddObjectDefItem(playerherdID, "elk", rmRandInt(8,8), 7.0);
...
//		rmSetAreaTerrainType(plateauforestID, "pampas\groundforest_pam");
		...
		for (j=0; < rmRandInt(9,10)) // 20,22
		{
			...
			rmAddObjectDefItem(plateauforesttreeID, "ypTreeHimalayas", rmRandInt(2,3), 3.0);
...
//		rmSetAreaTerrainType(valleyforestID, "pampas\groundforest_pam");
		...
		for (j=0; < rmRandInt(9,10)) // 20,22
		{
			...
			rmAddObjectDefItem(valleyforesttreeID, "Treegreatlakes", rmRandInt(2,3), 3.0);
