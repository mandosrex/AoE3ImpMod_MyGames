...
// Constraints
	...
	// Player constraints
	int playerConstraint=rmCreateClassDistanceConstraint("stay away from players", classPlayer, 22.0);
  ...
  // resource avoidance
	int avoidSilver=rmCreateTypeDistanceConstraint("gold avoid gold", "Mine", 25.0);
  int avoidUnderbrush=rmCreateTypeDistanceConstraint("underbrush avoid", "underbrushYukon", 35.0);
	int mediumAvoidSilver=rmCreateTypeDistanceConstraint("medium gold avoid gold", "mineGold", 20.0);
	int avoidHuntable1=rmCreateTypeDistanceConstraint("avoid huntable1", huntable1, 30.0);
	int avoidHuntable2=rmCreateTypeDistanceConstraint("avoid huntable2", huntable2, 30.0);
	...
	int avoidTradeRouteSockets=rmCreateTypeDistanceConstraint("avoid trade route sockets", "socketTradeRoute", 10.0);
...
// ************************** DEFINE OBJECTS ****************************
  ...
  int deerID=rmCreateObjectDef("huntable1");
	rmAddObjectDefItem(deerID, huntable1, rmRandInt(11,13), 6.0);
  ...
  int tapirID=rmCreateObjectDef("huntable2");
	rmAddObjectDefItem(tapirID, huntable2, rmRandInt(1,2), 6.0);
...
// Players
 ...
 // Ensure that starting outpost is near the gold
  ...
  rmAddObjectDefItem(startingOutpostAsianID, "mineGold", 1, 6.0);
  rmSetObjectDefMinDistance(startingOutpostAsianID, 12.0);
  rmSetObjectDefMaxDistance(startingOutpostAsianID, 16.0);
...
rmAddObjectDefConstraint(playerSaloonID, mediumAvoidSilver);
  rmAddObjectDefToClass(playerSaloonID, rmClassID("importantItem"));

// Starting Hunt
 int StartDeerID=rmCreateObjectDef("starting herd");
	rmAddObjectDefItem(StartDeerID, huntable1, 6, 4.0);
 ...
 rmAddObjectDefConstraint(StartDeerID, avoidImpassableLand);
  rmAddObjectDefConstraint(StartDeerID, avoidAll);
  ...
  rmAddObjectDefItem(playerBerryID, "berryBush", 3, 5.0);
  rmSetObjectDefMinDistance(playerBerryID, 8);
  rmSetObjectDefMaxDistance(playerBerryID, 12);
	rmAddObjectDefConstraint(playerBerryID, avoidAll);
  rmAddObjectDefToClass(playerBerryID, rmClassID("importantItem"));
rmAddObjectDefConstraint(playerBerryID, avoidImpassableLand);
  ...
  rmAddObjectDefConstraint(playerNuggetID, avoidTradeRoute);
    ...
    rmPlaceGroupingAtLoc(comancheVillageAID,0, 0.85, .61);
...
int lakotaVillageAID = -1;
    ...
    rmPlaceGroupingAtLoc(lakotaVillageAID, 0, 0.85, .35);
