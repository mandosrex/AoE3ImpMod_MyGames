...
// Pick pattern for trees, terrain, features, etc.
   int patternChance = rmRandInt(1,37); 
...
//   mineNumber = 0;
   ...
   {   
	...
	{     
         ...
         centerHerdType = "ypMarcoPoloSheep";        
	}
      if (sheepChance == 1)
         sheepType = "ypWaterBuffalo";
      else
...
// Native patterns
  ...
  {
      rmSetSubCiv(0, "zen");
      native1Name = "native zen temple cj 0";
...
// Precipitation
   ...
   if (patternChance == 8) // rockies
      if (lightingChance == 2)
         rmSetGlobalSnow( 0.5 );
   if ((patternChance == 31) || (patternChance == 36)) // himalayas, siberia
      if (rmRandInt(1,2) == 2)
         rmSetGlobalSnow( 0.5 );
